...
const roomStyles = ref([
  { name: 'Art Deco', image: '/typeAndStyle/style/artDeco.png' },
  { name: 'Asian Zen', image: '/typeAndStyle/style/asianZen.png' },
  { name: 'Bohemian (Boho Chic)', image: '/typeAndStyle/style/bohemian.jpg' },
  { name: 'Classic', image: '/typeAndStyle/style/classic.jpg' },
  { name: 'Coastal/Hamptons', image: '/typeAndStyle/style/coastal.png' },
  { name: 'Contemporary', image: '/typeAndStyle/style/contemporary.jpg' },
  { name: 'Eclectic', image: '/typeAndStyle/style/eclectic.png' },
  { name: 'Farmhouse', image: '/typeAndStyle/style/farmhouse.png' },
  { name: 'Hollywood Regency', image: '/typeAndStyle/style/hollywoodRegency.png' },
  { name: 'Industrial', image: '/typeAndStyle/style/industrial.jpg' },
  { name: 'Luxury', image: '/typeAndStyle/style/luxury.jpg' },
  { name: 'Mediterranean', image: '/typeAndStyle/style/mediterranean.png' },
  { name: 'Mid-Century Modern', image: '/typeAndStyle/style/midCentury.png' },
  { name: 'Minimalist', image: '/typeAndStyle/style/minimalist.jpg' },
  { name: 'Modern', image: '/typeAndStyle/style/modern.jpg' },
  { name: 'Rustic', image: '/typeAndStyle/style/rustic.jpg' },
  { name: 'Scandinavian', image: '/typeAndStyle/style/scandinavian.jpg' },
  { name: 'Shabby Chic', image: '/typeAndStyle/style/shabbychic.png' },
  { name: 'Transitional', image: '/typeAndStyle/style/transitional.png' },
  { name: 'Urban Modern', image: '/typeAndStyle/style/urbanModern.png' },
]);
