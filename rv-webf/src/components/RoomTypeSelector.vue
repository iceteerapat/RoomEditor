...
const roomTypes = ref([
  { name: 'Attic', image: '/src/assets/picture/typeAndStyle/style/attic.jpg' },
  { name: 'Basement', image: '/src/assets/picture/typeAndStyle/style/basement.jpg' },
  { name: 'Bathroom', image: '/src/assets/picture/typeAndStyle/style/bathroom.jpg' },
  { name: 'Bedroom', image: '/src/assets/picture/typeAndStyle/style/bedroom.jpg' },
  { name: 'Closet/Walk-in Closet', image: '/src/assets/picture/typeAndStyle/style/closet.jpg' },
  { name: 'Dining Room', image: '/src/assets/picture/typeAndStyle/style/dining.jpg' },
  { name: 'Entryway (Foyer/Mudroom)', image: '/src/assets/picture/typeAndStyle/style/entryway.jpg' },
  { name: 'Family Room', image: '/src/assets/picture/typeAndStyle/style/family.jpg' },
  { name: 'Fitness Room', image: '/src/assets/picture/typeAndStyle/style/fitness.jpg' },
  { name: 'Garage', image: '/src/assets/picture/typeAndStyle/style/garage.jpg' },
  { name: 'Hallway/Corridor', image: '/src/assets/picture/typeAndStyle/style/hallway.jpg' },
  { name: 'Home Office', image: '/src/assets/picture/typeAndStyle/style/homeOffice.jpg' },
  { name: 'Home Theater', image: '/src/assets/picture/typeAndStyle/style/hometheater.jpg' },
  { name: 'Kitchen', image: '/src/assets/picture/typeAndStyle/style/kitchen.jpg' },
  { name: 'Laundry Room', image: '/src/assets/picture/typeAndStyle/style/laundry.jpg' },
  { name: 'Living Room', image: '/src/assets/picture/typeAndStyle/style/living.jpg' },
  { name: 'Pantry', image: '/src/assets/picture/typeAndStyle/style/pantry.jpg' },
  { name: 'Playroom', image: '/src/assets/picture/typeAndStyle/style/playroom.jpg' },
  { name: 'Stairwell', image: '/src/assets/picture/typeAndStyle/style/stairewell.jpg' },
  { name: 'Sunroom', image: '/src/assets/picture/typeAndStyle/style/sunroom.jpg' },
  { name: 'Utility Room', image: '/src/assets/picture/typeAndStyle/style/utility.jpg' },
]);
