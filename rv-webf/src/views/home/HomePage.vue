...
<template>
    <div class="min-h-screen flex flex-col">
        ...
        <main class="flex-grow">
            <section class="bg-gradient-to-r from-blue-500 to-purple-600 text-white text-center py-20 px-4">
                ...
                <div class="container mx-auto">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                        <div class="bg-white rounded-lg shadow-lg p-6 text-center hover:shadow-xl transition-shadow duration-300">
                            <h3 class="text-xl font-semibold mb-2 text-blue-600">Easy to Use</h3>
                            <p class="text-gray-600">No experience needed & start designing in seconds.</p>
                        </div>
                        <div class="bg-white rounded-lg shadow-lg p-6 text-center hover:shadow-xl transition-shadow duration-300">
                            <h3 class="text-xl font-semibold mb-2 text-blue-600">Realistic Previews</h3>
                            <p class="text-gray-600">Visualize your room in stunning detail and 3D.</p>
                        </div>
                        <div class="bg-white rounded-lg shadow-lg p-6 text-center hover:shadow-xl transition-shadow duration-300">
                            <h3 class="text-xl font-semibold mb-2 text-blue-600">Save & Share</h3>
            ...
            <section class="py-16 px-4 bg-white">
                <div class="container mx-auto text-center">
                    ...
                    <h2 class="text-2xl md:text-3xl font-semibold text-left mb-6 md:mb-8 text-blue-600">Create Service</h2>
                    ...
                    <h2 class="text-2xl md:text-3xl font-semibold text-left mb-6 md:mb-8 text-blue-600">Renovate Service</h2>
                ...
                <div class="container mx-auto text-center">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div class="bg-white rounded-lg shadow-lg p-6 flex flex-col items-center text-center hover:shadow-xl transition-shadow duration-300">
                            ...
                            <h3 class="text-xl font-semibold mb-2 text-blue-600">Homeowners</h3>
                        ...
                        <div class="bg-white rounded-lg shadow-lg p-6 flex flex-col items-center text-center hover:shadow-xl transition-shadow duration-300">
                            ...
                            <h3 class="text-xl font-semibold mb-2 text-blue-600">Interior Designers</h3>
                        ...
                        <div class="bg-white rounded-lg shadow-lg p-6 flex flex-col items-center text-center hover:shadow-xl transition-shadow duration-300">
                            ...
                            <h3 class="text-xl font-semibold mb-2 text-blue-600">Real Estate Agents</h3>
            ...
            <section class="bg-gradient-to-r from-purple-600 to-blue-500 text-white text-center py-16 px-4">
